...
def test_multiple_robots():
    ...
    for robot_name in robots_to_test:
        ...
        try:
            ...
            orphaned = [
                link for link, meshes in app.urdf_viz.link_meshes.items()
                if meshes and link not in app.urdf_viz.link_frame
            ]
